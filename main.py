...
async def handle_chat(request: ChatRequest):
    ...
    if stage == "get_name":
        ...
        except EmailNotValidError: return ChatResponse(next_stage="get_email", bot_message="That email address seems invalid or doesn't exist. Please provide a correct email.", user_details=user_details)
        except Exception as e:
